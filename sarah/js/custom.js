...
// const logoElm = document.querySelector(".logo img");
// console.log(logoElm);
...
// const arr = [1, 2, 3, 4, 5, 6, 7, 4, 7, 5, 7, 7];

// console.log(arr);

// for (let i = 0; i < arr.length; i++) {
//   console.log(`안녕하세요 : ${arr[i]}`);
// } // 4. 반복문
...
imgWrap.addEventListener("mousemove", function (event) {
  ...
  const percent = Math.floor((x / screenWidth) * 200); // 전체 가로크기를 200으로 나눈 커서가 위치하는 x축 좌표 인덱스
